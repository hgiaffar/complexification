...
P = [0.6 0 0.4];      % probability distribution over variational operators
...
calc_pc = 1;            % compute phenotypic complexity as part of the Moran cycle step
num_samples_pc = 100;    % how many anchors in the phenotype simplex used to approximate the distribution          
num_mutations_pc = 25;  % number of phenotypes sampled through random mutation for a given genotype
sigma_pc = 1;         % variance of gaussian centered at each anchor point
...
beta_envt = 5;                  % softmax parameter

% report during simulation
reporting_interval = 500;      % for updating plots and calculating phenotypic complexity
